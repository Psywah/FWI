function [Q]=LinearInterpQ(p,zr,N, h)

 %% Linear Interpolant for source term in x direction
...
% Assumes z corrdinate of the source is constant (ie they are in a line)

% Inputs: 
%   p  = x source position, 
%   zr = z source position, 
%   no. nodes N, spzcing h
%   Outputs: R interpolant matrix
...
% Assume z is constant, i.e. z(1)=z(2)=...z(end) 
    ...
    Q=kron(Ix, Iz);                % define R as x & z interpolant
